...
interface RecipeDataSource {
    ...
    suspend fun fetchRecipes(fetchRecipeRequest: FetchRecipeRequest): List<Recipe>
...
class RecipeDataSourceImpl @Inject constructor(
    ...
    override suspend fun fetchRecipes(fetchRecipeRequest: FetchRecipeRequest): List<Recipe> {
        val response = networkServiceApi.recipes(fetchRecipeRequest)
