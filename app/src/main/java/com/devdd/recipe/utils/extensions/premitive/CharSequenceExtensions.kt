...
fun CharSequence.textSize(spSize: Float): CharSequence =
    applyStyles(AbsoluteSizeSpan(DisplayUtils.spToPx(spSize)))

fun CharSequence.font(font: Typeface): CharSequence = applyStyles(CustomFontTypefaceSpan(font))
